...
namespace ai {
	...
	void Simple_ai_comp::load(core::ecs::Entity_state& state) {
	...
	void Simple_ai_comp::store(core::ecs::Entity_state& state) {
		state.write_from(Persisted_state{*this});
	}


	Simple_ai_comp::Simple_ai_comp(core::ecs::Entity& owner)
	...
	void Simple_ai_comp::no_target(core::Time dt)noexcept {
		if(_target) {
