...
namespace mo {
	...
	class Menu_Screen : public Screen {
		public:
			Menu_Screen(Game_engine& game_engine);
			~Menu_Screen()noexcept = default;
		...
		private:
			...
			renderer::Textured_box _newGame;
			renderer::Textured_box _loadGame;
			renderer::Textured_box _settings;
			renderer::Textured_box _quit;
